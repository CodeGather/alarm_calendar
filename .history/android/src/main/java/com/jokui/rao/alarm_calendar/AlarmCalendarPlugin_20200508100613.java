...
public class AlarmCalendarPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public FlutterAlarmCalendarPlugin initPlugin(MethodChannel methodChannel, Registrar registrar) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new FlutterAlarmCalendarPlugin().initPlugin(channel,registrar));
  }
